...
void Sculptor::putVoxel(int x, int y, int z){
    //checando se os parâmetros estão dentro do range da matriz
    while (true){
        if (x < 0){
            x = 0;
        }
...
void Sculptor::putBox(int x0, int x1, int y0, int y1, int z0, int z1){
    ...
    //checando se os parâmetros finais são maiores que os iniciais
    while (true){
        if (x0 > x1){
            troca(x0, x1);
        }
    ...
    //checando se os parâmetros informados estão no range da matriz
    while (true){
        //valores menores que 0 se tornam 0, valores maiores que o tamanho
        //naquela dimensão recebem o valor máximo da respectiva dimensão
        if (x0 < 0){
            x0 = 0;
        }
        if (y0 < 0){
